...
3. Enter the `./src` directory and make any changes that you want to the `propass.ts` file or `syllables.json` file. If you would like to, you could take a look at the [DEVNOTES](https://github.com/josh-clarke/propass/blob/main/DEVNOTES.md) file.
