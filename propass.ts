...
interface Syllables {
    ...
    'doubleConsonants': Array<Array<{'char': string, 'weight': string}>>,
    'singleVowels': Array<Array<{'char': string, 'weight': string}>>,
    'doubleVowels': Array<Array<{'char': string, 'weight': string}>>,
    'numbers': Array<string>,
    'symbols': Array<string>
}

// Variables
const syllables: Syllables = require('./syllables.json')
...
function generatePassword(passwordLength, numbersLength, symbolsLength, optionsLength, caps, mix) {
    ...
    for (let o:number = 0; o < optionsLength; o++) {
        ...
        if(mix) {
            let shuffledPass:Array<string> = shuffleArray(password)
